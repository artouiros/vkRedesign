...
var a = location.pathname;
    ...
    switch (a) {
        ...
        case "/ads":
            ...
            break;
         case "/im":         
          if(href.search("sel=") > 0){
             $(".im-right-menu.ui_rmenu").attr("id","rmTopMesBar");
			 }else{
              $(".im-right-menu.ui_rmenu").attr("id","addTopMesBar");
             }
            break;
        case "/search":
            $(".ui_rmenu_item, .ui_rmenu_subitem").addClass("verticalMenu");
